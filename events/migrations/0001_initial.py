# Generated by Django 3.2.15 on 2024-01-26 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateField(auto_now=True, verbose_name='Modified')),
                ('active', models.BooleanField(default=True, verbose_name='Active')),
                ('subscribed_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribed_event', to='events.event')),
